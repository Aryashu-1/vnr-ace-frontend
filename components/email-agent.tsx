      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm space-y-4">
          ...
          <textarea 
            ...
            className="w-full h-32 p-4 border border-gray-300 rounded-xl text-sm outline-none focus:border-emerald-500 transition-all resize-none font-inter"
          />
          <button 
            onClick={() => handleProcess()}
            disabled={loading || !input.trim()}
            className="w-full bg-emerald-600 text-white font-bold py-3 rounded-xl hover:bg-emerald-700 disabled:bg-gray-300 transition-all flex items-center justify-center gap-2 shadow-sm"
          >
        ...
        <div className="space-y-6">
          {state ? (
              ...
              {state.approval_required && (
                <div className="flex gap-3 mt-6">
                  <button 
                    ...
                    className="flex-1 bg-emerald-600 text-white py-2 rounded-lg text-sm font-bold flex items-center justify-center gap-2 hover:bg-emerald-700 transition-all shadow-sm"
                  >
            ...
            <div className="bg-slate-50 border border-slate-200 border-dashed rounded-xl p-8 flex flex-col items-center justify-center h-full min-h-[300px] text-center">
              ...
              <p className="text-slate-400 text-sm max-w-xs italic font-inter">
